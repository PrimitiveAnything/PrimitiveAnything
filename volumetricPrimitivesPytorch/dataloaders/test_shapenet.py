...
def test_import_shapenet():
   try:
      import volumetricPrimitivesPytorch.data.shapenet as shapenet
...
def test_r2n2shapenetdataset_instantiation():
   from volumetricPrimitivesPytorch.data.shapenet import R2N2ShapeNetDataset
   try:
      dataset = R2N2ShapeNetDataset(r2n2_shapenet_dir="data/r2n2_shapenet")
